	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<h6 class="mb-4">Doesn't have an Orphanage account<a style="float:right" href ="register.php">Register</a></h6>
				<h6 class="mb-4">Doesn't have an Donor account<a style="float:right" href ="donor_register.php">Register</a></h6>
