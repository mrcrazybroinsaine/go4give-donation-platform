		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Orphanage Register</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="../controller/o_register.php" method='post' enctype="multipart/form-data" class="signin-form">
                  ...
                  <div class="form-group">
		      		...
		      		<div class="form-group">
		      			<input type="text" class="form-control" name="Orph" placeholder="Orphanage/Old Age" required>
