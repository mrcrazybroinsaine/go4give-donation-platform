                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                      <?php
                       $stmt=$admin->ret("SELECT * FROM `donation` inner join `donor` on donation.d_id=donor.d_id where `o_id`='$o_id' and `do_status`=''");
                     ...
                     <tr>
                       ...
                       <td><?php echo $row['d_phone']; ?></td>
                          ...
                          <td><a class="btn btn-primary" href="../../controller/receipt.php?do_id=<?php echo  $row['do_id']; ?>">Send Recipt</a></td>
</tr>
 <?php } ?>
                      </tbody>
