...
<body>
    ...
    <!-- <section class="ftco-section ftco-no-pb">
        ...
        <select class="form-control" name="" onchange="Search(this.value)" id="">
        ...
        <div class="container">
            <div class="row justify-content-center pb-5 mb-3">
                <div class="col-md-7 heading-section text-center ftco-animate">
                    <span class="subheading">Our Orphanages/Old age homes</span>
                    <h2>Donate to needy people around the country</h2>
                </div>
            </div>
            <div class="row" id="search">
                <?php
                $stmt3 = $admin->ret("SELECT * FROM `orphanage`");
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="causes causes-2 text-center ftco-animate">
                            <a href="#" class="img w-100"
                                style="background-image: url(../controller/<?php echo $row3['o_photo']; ?>);"></a>
                            <div class="text p-3">
                                <h2><a href="#">
                                        <?php echo $row3['o_name']; ?>
                                    </a></h2>
                                <p>
                                    <?php echo $row3['o_email']; ?>
                                </p>
                                <p>
                                    <?php echo $row3['o_phn']; ?>
                                </p>
                                <p>
                                    <?php echo $row3['o_address']; ?>
                                </p>

                                <p><a href="donation.php?o_id=<?php echo $row3['o_id']; ?>"
