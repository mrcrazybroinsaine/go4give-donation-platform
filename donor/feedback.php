						...
						<div class="row no-gutters">
							<div class="col-md-7">
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<form method="POST" action="../controller/feedback.php" id="contactForm" name="contactForm" class="contactForm">
										<div class="row">
											<div class="col-md-6">
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="#">Feedback Message</label>
													<textarea name="message" class="form-control" id="message" cols="30" rows="4" placeholder="Feedback"></textarea>
												</div>
											</div>
											<input type="hidden" value="<?php echo $o_id; ?>" name="o_id">
											<div class="col-md-12">
												<div class="form-group">
													<input type="submit" name="feed" value="Send Feedback" class="btn btn-primary">
							...
							<div class="col-md-5 d-flex align-items-stretch">
								<div class="info-wrap w-100 p-5 img" style="background-image: url(images/about-4.jpg);">
								</div>
							</div>
						</div>
					</div>
