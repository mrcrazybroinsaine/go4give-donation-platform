      ...
      <div class="row d-flex no-gutters">
        ...
        <div class="col-md-6 pr-md-5 py-md-5">
          <div class="heading-section pt-md-5 mb-4">
            ...
            <p>Our website is to improving the lives of orphanage and old age people by providing them with essential support and resources. We strive to create a nurturing and caring environment where they can thrive and feel valued. Through our initiatives, we aim to address their basic needs, including food, shelter, healthcare, and education. Our goal is to make a lasting impact and bring smiles to their faces.
</p><p>About the Owner of the Website:</p><p>

The owner of this website is a compassionate individual who has a deep passion for helping others. With a strong commitment to making a positive difference in the lives of orphanage and old age people, the owner Initiated this platform to facilitate donations and raise awareness about the needs of these vulnerable individuals. Driven by empathy and a desire to create a better world, the owner envisions a society where every person receives the care and support they deserve.
</p>
    ...
    <div class="container">
      ...
      <!-- <div class="row" style="text-center"> -->
        <!-- <div class="col-md-3 services-2 w-100 text-center">
          <div class="icon icon-1 d-flex align-items-center justify-content-center"><span
              class="flaticon-water-drop"></span></div>
          <div class="text">
            <h4>Water</h4>
        ...
        <div class="col-md-3 services-2 w-100 text-center">
          <div class="icon icon-3 d-flex align-items-center justify-content-center"><span class="flaticon-bread"></span>
          </div>
          <div class="text">
            <h4>Food</h4>
            <p>Far far away, behind the word mountains, far from the countries.</p>
        ...
        <div class="col-md-3 services-2 w-100 text-center">
          <div class="icon icon-4 d-flex align-items-center justify-content-center"><span
              class="flaticon-university"></span></div>
          <div class="text">
            <h4>Education</h4>
            <p>Far far away, behind the word mountains, far from the countries.</p>
          </div>
