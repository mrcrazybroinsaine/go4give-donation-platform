		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end">
				<!-- <div class="col-md-9 ftco-animate pb-5">
					...
					<p ><h1 class="mb-0 bread">Contact us</h1></P>
				</div>
			</div>
		</div>
	</section>
						...
						<div class="row mb-5">
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p><span>Address:</span> 	go4give. section 2B, East Delhi, India,</p>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p><span>Phone:</span> <a href="tel://1234567920">9876543210</a></p>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p><span>Email:</span> <a href="mailto:info@yoursite.com">go4give@gmail.com</a></p>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p><span>Website</span> <a href="#">go4give.com</a></p>
									</div>
								</div>
							</div>
						</div>
