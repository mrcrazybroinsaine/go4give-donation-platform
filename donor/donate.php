...
$fu_id = $_GET['fu_id'];
$stmt2=$admin->ret("SELECT * FROM `fundraiser` where `fu_id`='$fu_id'");
						...
						<div class="row no-gutters">
							<div class="col-md-7">
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<form method="POST" action="../controller/donate.php" id="contactForm" name="contactForm" class="contactForm">
										<div class="row">
											<div class="col-md-6">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="dtype" id="subject" placeholder="Donation Type">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="subject">Amount</label>
													<input type="text" class="form-control" name="amount" id="subject" placeholder="Amount">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="#">Description</label>
													<textarea name="des" class="form-control" id="message" cols="30" rows="4" placeholder="Description"></textarea>
												</div>
											</div>
